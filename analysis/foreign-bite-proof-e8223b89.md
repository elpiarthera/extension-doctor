# foreign-bite-probe run log — HEAD e8223b89
...
=== net-broadcast-unfiltered ===
  ...
  MUTATION-LANDED: "function relayToOpenTabs(payload) {" found in /tmp/ed-fbp-net-broadcast-unfiltered-fail-F9We5a/src/background/background.ts
...
=== description-permission-mismatch ===
  ...
  MUTATION-LANDED: "conversations in sync across Grok" found in /tmp/ed-fbp-description-permission-mismatch-fail-KrXkNo/manifest.json
...
=== csp-not-weakened ===
  ...
  MUTATION-LANDED: "object-src 'self'; script-src 'unsafe-eval' 'self'" found in /tmp/ed-fbp-csp-not-weakened-fail-gZgcmk/manifest.json
...
=== sw-listeners-toplevel ===
  ...
  MUTATION-LANDED: "async function bootstrapAlarmWatchers() {" found in /tmp/ed-fbp-sw-listeners-toplevel-fail-XbHnZX/src/background/background.ts
...
=== secret-in-bundle ===
  ...
  MUTATION-LANDED: "const awsIngestKeyId" found in /tmp/ed-fbp-secret-in-bundle-fail-5aZiBC/dist/sidebar.js
...
=== host-permissions-wildcard-broad ===
  ...
  MUTATION-LANDED: ""*://*/*"" found in /tmp/ed-fbp-host-permissions-wildcard-broad-fail-3k51i0/manifest.json
...
=== i18n-key-coverage-gap ===
  ...
  MUTATION-LANDED: "labelKey: 'openmemory_sync_status_v2'" found in /tmp/ed-fbp-i18n-key-coverage-gap-fail-UNB05J/ui/popup.ts
...
=== unused-file-export ===
  ...
  MUTATION-LANDED: "chrome.runtime.onMessage.addListener" found in /tmp/ed-fbp-unused-file-export-fail-qWR1qW/src/features/selection_context.ts
