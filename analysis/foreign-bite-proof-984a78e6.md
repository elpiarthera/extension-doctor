# foreign-bite-probe run log — HEAD 984a78e6
...
=== net-broadcast-unfiltered ===
  ...
  MUTATION-LANDED: "function relayToOpenTabs(payload) {" found in /tmp/ed-fbp-net-broadcast-unfiltered-fail-ySvpWr/src/background/background.ts
...
=== sw-listeners-toplevel ===
  ...
  MUTATION-LANDED: "async function bootstrapAlarmWatchers() {" found in /tmp/ed-fbp-sw-listeners-toplevel-fail-Fms4sF/src/background/background.ts
...
=== secret-in-bundle ===
  ...
  MUTATION-LANDED: "const awsIngestKeyId" found in /tmp/ed-fbp-secret-in-bundle-fail-4X41mp/dist/bundle.js
...
=== description-permission-mismatch ===
  ...
  MUTATION-LANDED: "Sync your conversations across Grok" found in /tmp/ed-fbp-description-permission-mismatch-fail-3T9nCr/manifest.json
...
=== csp-not-weakened ===
  ...
  MUTATION-LANDED: "object-src 'self'; script-src 'unsafe-eval' 'self'" found in /tmp/ed-fbp-csp-not-weakened-fail-IT11Go/manifest.json
...
=== host-permissions-wildcard-broad ===
  ...
  MUTATION-LANDED: ""*://*/*"" found in /tmp/ed-fbp-host-permissions-wildcard-broad-fail-pbMfRJ/manifest.json
...
=== i18n-key-coverage-gap ===
  ...
  MUTATION-LANDED: "labelKey: 'ghosttext_sync_status_v2'" found in /tmp/ed-fbp-i18n-key-coverage-gap-fail-9flQ1d/ui/popup.ts
...
=== unused-file-export ===
  ...
  MUTATION-LANDED: "chrome.storage.sync.get" found in /tmp/ed-fbp-unused-file-export-fail-Z77nlt/src/features/orphan.ts
