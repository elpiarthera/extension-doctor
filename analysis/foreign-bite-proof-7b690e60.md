# foreign-bite-probe run log — HEAD 7b690e60
...
=== net-broadcast-unfiltered ===
  ...
  foreign-file: src/background.ts (source: mem0-chrome-extension @ 54a882a, MIT, fetched at runtime)
  injected-variant: promise .then() chain (not await), odd inner spacing "query(  {  }  )", different names (relayToOpenTabs/openTabs/ot), no try/catch — appended to real mem0-chrome-extension background.ts (which as fetched has zero broadcast bug)
  MUTATION-LANDED: "function relayToOpenTabs(payload) {" found in /tmp/ed-fbp-net-broadcast-unfiltered-fail-78DFBP/src/background/background.ts
  ...
  RESTORED: /tmp/ed-fbp-foreign-fetch-RwXkzd/src/background.ts byte-identical to pre-injection copy, sha256 unchanged (ce463763eaa3…)
...
=== description-permission-mismatch ===
  ...
  foreign-file: manifest.json (source: mem0-chrome-extension @ 54a882a, MIT, fetched at runtime)
  ...
  MUTATION-LANDED: "conversations in sync across Grok" found in /tmp/ed-fbp-description-permission-mismatch-fail-NvE2tF/manifest.json
  ...
  RESTORED: /tmp/ed-fbp-foreign-fetch-RwXkzd/manifest.json byte-identical to pre-injection copy, sha256 unchanged (0908bc6a7d39…)
...
=== csp-not-weakened ===
  ...
  MUTATION-LANDED: "object-src 'self'; script-src 'unsafe-eval' 'self'" found in /tmp/ed-fbp-csp-not-weakened-fail-by2KeY/manifest.json
...
=== sw-listeners-toplevel ===
  ...
  MUTATION-LANDED: "async function bootstrapAlarmWatchers() {" found in /tmp/ed-fbp-sw-listeners-toplevel-fail-X0bx3g/src/background/background.ts
...
=== secret-in-bundle ===
  ...
  foreign-file: src/sidebar.ts (source: mem0-chrome-extension @ 54a882a, MIT, fetched at runtime)
  ...
  MUTATION-LANDED: "const awsIngestKeyId" found in /tmp/ed-fbp-secret-in-bundle-fail-D6QJ1j/dist/sidebar.js
  ...
  RESTORED: /tmp/ed-fbp-foreign-fetch-RwXkzd/src/sidebar.ts byte-identical to pre-injection copy, sha256 unchanged (67e4da656ebb…)
...
=== host-permissions-wildcard-broad ===
  ...
  MUTATION-LANDED: ""*://*/*"" found in /tmp/ed-fbp-host-permissions-wildcard-broad-fail-0szj9I/manifest.json
...
=== i18n-key-coverage-gap ===
  ...
  foreign-file: src/popup.ts (source: mem0-chrome-extension @ 54a882a, MIT, fetched at runtime)
  injected-variant: real mem0-chrome-extension popup.ts (verbatim, 35 lines, zero t()/labelKey usage as fetched) mutated by appending an object literal using the OTHER call-site shape the rule matches — "labelKey: 'openmemory_sync_status_v2'" (not a direct t('x') call) — key absent from both locale files
  MUTATION-LANDED: "labelKey: 'openmemory_sync_status_v2'" found in /tmp/ed-fbp-i18n-key-coverage-gap-fail-MAkHNp/ui/popup.ts
  ...
  RESTORED: /tmp/ed-fbp-foreign-fetch-RwXkzd/src/popup.ts byte-identical to pre-injection copy, sha256 unchanged (cc3a231296c3…)
...
=== unused-file-export ===
  ...
  foreign-file: src/selection_context.ts (source: mem0-chrome-extension @ 54a882a, MIT, fetched at runtime)
  ...
  MUTATION-LANDED: "chrome.runtime.onMessage.addListener" found in /tmp/ed-fbp-unused-file-export-fail-q3VDO1/src/features/selection_context.ts
  ...
  RESTORED: /tmp/ed-fbp-foreign-fetch-RwXkzd/src/selection_context.ts byte-identical to pre-injection copy, sha256 unchanged (1944734761fd…)
