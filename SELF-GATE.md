...
| [x] | Foreign-material bite proof — 8 sampled rules RED on unchosen material | `node scripts/foreign-bite-probe.mjs` | exit 0 — `8/8 rules RED+INCONCLUSIVE+RESTORED on foreign material` (see `analysis/foreign-bite-proof-a0c9209c.md`) |
